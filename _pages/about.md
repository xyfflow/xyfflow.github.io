...
- System:
	- AI Framework
	- Inference Engine: model compression & kernel library
	- AI Compiler
...
# How to handle the relationship with mentor ?
...
- The premise for a real research is to write the prj & report well. However,when stepped into the forefront, people use the  cutting edge methods ideas and methods. 
- Computer system and architecture researcher should have a critical thinking and overall view.

- As a freshman, we should look mature framework code. trade-off: focusing on non-trivial
...
- kiss: keep it simple, stupid. move fast & break things,
- maximize ROI

- 九阴真金: 基础 思维 熟练度
- 框架→细节，完成→完善，量变→质变，定时反馈闭环

- 正确的方向做正确的事，唯一的信念就是你在变强.

- 眼界决定上限，能力决定下限.

- 抓住主要矛盾，在自己做的方向上保持专注，注重落地.
- 人有所不为也，而后可以有为–>去做难的事情.
